...
export default function MyCommentReview() {
 ...
 const handleSendCheckedComment = () => {
   ...
   console.log("삭제 요청할 데이터 구조:", JSON.stringify(selectedComments, null, 2));
   ...
   <MyCommentReviewLayout>
     ...
     {isAlertOpen && (
       <DelAlert
         ...
         func={() => {
           console.log("DELETE API 요청 데이터:", JSON.stringify(selectedComments, null, 2));
           try {
             // TODO: 댓글/리뷰 삭제 API 구현 필요
             fetchComments();
           } catch (error) {
